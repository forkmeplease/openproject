...
const WIDGET_FRAME_ID = 'overviews-widgets-project-status-component';
const WIDGET_NAME = 'project_status';
...
export class WidgetProjectStatusBetaComponent extends AbstractWidgetComponent {
  ...
  get src():string|null {
    ...
    return this.pathHelper.projectWidgetPath(this.currentProject.identifier, WIDGET_NAME);
  }
