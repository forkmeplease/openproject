...
| PM² Artefacts                                                | Custom work package types                        | [List of all PM² artefacts](https://pm2.openproject.com/projects/pm2-test/work_packages?query_id=68) | Automatically created artefact in new documents module       |
