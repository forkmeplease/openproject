  ...
  context "with types" do
    ...
    it "renders row content" do
      expect(rendered_component).to have_css("li", text: types.first.name) do |row|
        ...
        expect(row).to have_link("Copy", href: new_workflow_copy_from_type_path(types.first))
      end
      expect(rendered_component).to have_css("li", text: types.second.name) do |row|
        ...
        expect(row).to have_link("Copy", href: new_workflow_copy_from_type_path(types.second))
      end
    end
  end
end
